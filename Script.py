class script(object):
    START_TXT = """Hᴇʏ {}, {}\n\n<b>I ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ.</b></a>"""
...
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
    ...
    ABOUT_TXT = """<b>‣ Mʏ ɴᴀᴍᴇ : {}\n‣ Cʀᴇᴀᴛᴏʀ :</b> <a href='https://t.me/'>螿 Sᴜɴɢ•Jɪɴᴡᴏᴏ ࿐</a>\n<b>‣ Lɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ Lᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : Hostinger\n‣ Bᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ4.2 [sᴛᴀʙʟᴇ]</b>"""
...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs @AS_Jinwoo</b>"""
...
🌿 Pᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.me/AS_Jinwoo'>螿 Sᴜɴɢ•Jɪɴᴡᴏᴏ ࿐</a></b>"""
...
• ᴍᴀɪɴ ᴏᴡɴᴇʀ : <a href="https://t.me/AS_Jinwoo">螿 Sᴜɴɢ•Jɪɴᴡᴏᴏ ࿐</a>
• ʙᴀꜱᴇ ʀᴇᴘᴏ : <a href="https://t.me/Evamaria">EvaMaria</a>
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ 📂 <i><a href="https://telegram.me/AS_Jinwoo">{file_name}</a></i>\n\n"""
...
💵 ᴜᴘɪ ɪᴅ - <code>Ab-samad@fam</code>
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://i.ibb.co/B5g7m1DC/file-1362.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/AS_Jinwoo'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
-Dev [Owner of this bot ]<a href='https://t.me/Itz_Sahil_Official'>♡ 𝚂𝙰𝙷𝙸𝙻 ♡</a>
"""
