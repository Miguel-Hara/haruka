...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1702061654 7357726710').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BQRequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BinaryQuest')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001768252356')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/BQChats') #Support group link ( make sure bot is admin )
