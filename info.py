...
BOT_TOKEN = environ.get('BOT_TOKEN', "7278934270:AAGusP0z13OLseUId9TDsvqv95vCBmBjNbE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002164008302').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://smkbotz:ldLTSrxVrGMBbUai@cluster0.td2kw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MSG_ALRT = environ.get('MSG_ALRT', 'Pᴏᴡᴇʀᴇᴅ Bʏ ♡ 𝚂𝙰𝙷𝙸𝙻 ♡')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002328437358')) #Log channel id ( make sure bot is admin )
